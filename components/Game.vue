<template>
    <div>
                    ...
                    <form id="form" @submit.prevent="submit">
                        ...
                        <div class="form-check abc-checkbox abc-checkbox-circle my-2">
                            ...
                            <label class="form-check-label t-12px" for="checkbox1">
                                J'ai bien pris connaissance des conditions <br>de participation et
                                <span style="text-decoration: underline" data-toggle="modal" data-target="#modalReglement">j'accepte le règlement du jeu concours</span>
                            </label>
                        </div>
                        <div class="form-check abc-checkbox abc-checkbox-circle my-2">
                            <input
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalReglement" tabindex="-1" role="dialog"
             aria-labelledby="modalReglementTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="background: white">
                    ...
                    <div class="modal-body">
                        ...
                        <p>
                            Le jeu <strong>«SOJADE»</strong>, gratuit et sans obligation d’achat, sera ouvert aux
                            personnes physiques
                        ...
                        <br>
                        <p>
                            Le jeu se déroulera du <strong>18 Avril au 16 Juin 2019</strong> inclus sur le site <a
                                target="_blank" href="https://www.marieclaire.fr/idees/">www.marieclaire.fr/idees/</a>
                        </p>
                        <h3>Le principe</h3>
                        <p>
                            ...
                            <a target="_blank" href="https://www.marieclaire.fr/idees/">
                                www.marieclaire.fr/idees/
                            </a> à la page :
                            <a target="_blank" href="https://www.marieclaire.fr/idees/sojade">
                                https://www.marieclaire.fr/idees/sojade
                            </a>
                            <br>
                            <br>
                        </p>
                        <ul>
                            <li class="mt-1">• se connecter sur la page web dédiée au jeu Disney, accessible sur le site
                                www.marieclaire.fr/idees/
                            </li>
                            <li class="mt-1">• compléter le formulaire d’inscription mis en ligne en précisant <br>impérativement
                                les
                                informations suivantes du formulaire :<br>
                                Nom
                                Prénom
                                Email
                                Adresse
                            ...
                            <li class="mt-1">• cocher la case « J'ai bien pris connaissance des conditions de
                                participation et
                                j'accepte
                                le
                                règlement du jeu concours »,
                            </li>
                            <li class="mt-1">• En option, cocher la case « Je souhaite recevoir les offres de SOJADE»
                            </li>
                            <li class="mt-1">• En option, cocher la case « Je m'inscris à la newsletter hebdomadaire de
                                Marie Claire
                                idées »
                            </li>
                        ...
                        <p>
                            La participation ne sera prise en compte qu’une fois le formulaire d’inscription validé.
                        </p><br>
                        <p>
                        ...
                        <p>
                            Il y aura au total <strong>5 gagnants</strong>, qui seront déterminés par tirage au sort
                        ...
                        <p>
                            Il ne sera fait aucun envoi par courrier de la description du lot et du nom des gagnants.
                        </p><br>
                        <p>
                        ...
                        <ul>
                            ...
                            <li class="mt-1">• Une copie de la facture de l'opérateur téléphonique et/ou fournisseur
                                d'accès Internet
                                au
                                nom
                        ...
                        <p>- Incomplètes (coordonnées incomplètes, absence du nom du jeu; absence de la date de
                        ...
                        L’exercice de ces droits se fera par écrit à l’adresse mentionnée ci-dessus ou par email à
                            <a href="mailto:dpo-jeuxgmc@gmc.tm.fr"> po-jeuxgmc@gmc.tm.fr</a>.
                        </p><br>
                        <p>
                        ...
                        site <a target="_blank" href="http://www.magicmaman.com">www.magicmaman.com</a>
                        </p><br>
                        <p>
                        Il ne sera fait aucun envoi par courrier de la description du lot et du nom des gagnants.
                        </p><br>
                        ...
                        <h3>Réclamations</h3>
                        <p>
                        Toute réclamation devra se faire par écrit à :
                        </p><br>
                        <p>
                        ...
                        <p>
                        Le règlement est consultable dans son intégralité sur la page dédiée au jeu :
                        </p><br>
                        <p>
                            <a target="_blank" href="https://www.marieclaire.fr/idees/sojade">https://www.marieclaire.fr/idees/sojade</a>
                        </p><br>
                        <p>
