<template>
  <div>
    <div
      class="products__presentation d-flex flex-column align-items-center justify-content-center py-4"
    >
      <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center">
              ...
              >
                <div class="d-flex flex-column align-items-center">
                  ...
                  <a :href="product.link" class="s-button bg-white t-p-green my-2">Voir la gamme</a>
                </div>
              </div>
            </div>
          </div>
